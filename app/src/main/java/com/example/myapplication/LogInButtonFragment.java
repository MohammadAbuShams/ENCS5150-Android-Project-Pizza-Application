 ...
 * Use the {@link LogInButtonFragment#newInstance} factory method to
...
public class LogInButtonFragment extends Fragment {
    ...
    public static LogInButtonFragment newInstance(String param1, String param2) {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        Button btnOpenLogIn = (Button) getActivity().findViewById(R.id.btnOpenLogIn);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_log_in_button, container, false);
    }
}